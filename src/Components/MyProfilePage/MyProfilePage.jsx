                ...
                <div className="card-body items-center text-center space-y-4">
                    {isEditing ? (
                        <form onSubmit={handleUpdateProfile} className="w-full space-y-4">
                            ...
                            <div className="text-left">
                                <label className="label">
                                    <span className=" text-sm sm:text-base">Photo URL</span>
                                </label>
                                <input
                                    type="text"
                                    value={photoURL}
                            ...
                            <div className="card-actions justify-center space-x-2 mt-7">
                                ...
                                <button
                                    type="button"
                                    className="rounded bg-gray-300  px-4 sm:px-5 py-2 font-bold text-gray-800 border transition hover:-translate-y-0.5 hover:bg-gray-400 hover:text-black text-sm sm:text-base"
